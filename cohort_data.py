...
def all_data(filename):
    ...
    all_cohort_data = open(filename)

    for line in all_cohort_data:
      first, last, house, prof, cohort_name = line.rstrip().split('|')
      all_data.append((f'{first} {last}', house, prof, cohort_name))
